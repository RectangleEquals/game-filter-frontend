...
import MarkAriaColor from 'assets/mark_and_aria_color.png';
  ...
  const getAsset = () => {
    ...
    if (props && props.className) {
      if(props.className.startsWith('asset-website-logo'))
        ...
        return UFO;
      else if(props.className.startsWith('asset-markaria-bw'))
        return MarkAriaBW;
      else if(props.className.startsWith('asset-markaria-color'))
        return MarkAriaColor;
